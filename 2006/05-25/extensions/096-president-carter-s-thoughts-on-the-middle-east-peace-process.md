...
lasting peace in the Middle East.
     ...
     explained a frustrated DeLee. ``But by failing to provide the 
     president with a real national security waiver, by failing to 
     include a sunset clause for draconian performance 
     requirements that will stay on the books regardless of who is 
     running the Palestinian Authority, and by failing to 
     distinguish between Hamas and Palestinians who support a two-
     state solution, the supporters of this bill have missed that 
     opportunity for now.''
