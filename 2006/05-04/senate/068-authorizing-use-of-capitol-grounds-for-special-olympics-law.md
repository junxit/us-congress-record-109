...
# AUTHORIZING USE OF CAPITOL GROUNDS FOR SPECIAL OLYMPICS LAW ENFORCEMENT TORCH RUN

```
AUTHORIZING USE OF CAPITOL GROUNDS FOR SPECIAL OLYMPICS LAW ENFORCEMENT 
                               TORCH RUN

  Mr. FRIST. I ask unanimous consent that Senate proceed to the 
immediate consideration of H. Con. Res. 359 which was received from the 
House.
  The PRESIDING OFFICER. The clerk will report the concurrent 
resolution by title.
  The assistant legislative clerk read as follows:

       A concurrent resolution (H. Con. Res. 359) authorizing the 
