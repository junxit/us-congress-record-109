...
down protectionism.''
     ...
     company with multinational operations has a lot more wriggle 
     room when it comes to regulations it doesn't like. 
     ...
     governments recognised this, which is why the government used 
     to have a ``golden share'' in a lot of privatisation 
     companies. There are, quite feasibly, a lot of uncommon but 
     not impossible situations in which a democratic government 
     might want to pass a law about the operations of a company, 
     and not want to find itself being taken to a WTO tribunal for 
     doing so.
