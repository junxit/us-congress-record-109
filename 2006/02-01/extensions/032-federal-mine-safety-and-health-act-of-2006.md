...
could beam reports around the Earth in an instant, it defies logic that 
we could not communicate with those men just a few thousand feet 
...
cap, nothing less.
     ...
     operators to expeditiously

[[Page 685]]

     provide notification of any accident where rescue work is 
     necessary, and require that the Mine Health and Safety 
     Administration implement a system to immediately receive 
     these notifications.
     ...
     teams including the number of each team's members and the use 
     of contractor teams, as well as liability and insurance 
     issues.
