---
granule: CRECB-2005-pt1-Pg659-3
date: 2005-01-25
edition: CRECB
section: SENATE
page: 659
...
harmful emissions of sulfur dioxides (SO<INF>X</INF>), nitrogen oxides 
(NO<INF>X</INF>), mercury, and carbon dioxide from fossil fuel power 
plants. More than 25,000 people are dying prematurely every year 
because of fine particulate pollution (PM<INF>-2.5</INF>) that is 
emitted by power plants in the form of SO<INF>X</INF> and 
NO<INF>X</INF>. More than 4,000 people are dying of heart attacks due 
...
(NO<INF>X</INF>), the primary cause of smog, by 71 percent from 2000 
levels; sulfur dioxide (SO<INF>2</INF>), that causes acid rain and 
...
(CO<INF>2</INF>), the greenhouse gas most directly linked to global 
climate change, by 21 percent from 2000 levels. Of note, the 
NO<INF>X</INF>, SO<INF>2</INF>, and mercury reductions are set at 
...
for three other pollutants--NO<INF>X</INF>, SO<INF>X</INF>, and 
CO<INF>2</INF>--by using market-oriented mechanisms to meet emissions 
...
for CO<INF>2</INF>. While I recognize that the pollutants listed under 
...
indirectly, all of us.
  I am supporting the goal of CO<INF>2</INF> emissions reduction in the 
Jeffords' bill in the hopes that the bill will be a rallying point to 
further the debate for reducing CO<INF>2</INF> and at the same time, 
get our air cleaner on a quicker timeframe. In particular, Congress 
needs to develop a market mechanism approach for CO<INF>2</INF> 
emissions trading--such as we now have for acid rain--to allow U.S. 
industries the flexibility and certainty to reduce CO<INF>2</INF> 
...
CO<INF>2</INF> emissions as it is the first state in the nation to 
...
will also inventory and reduce CO<INF>2</INF> emissions from state-
funded programs and facilities, and to spur at least 50 partnerships 
with businesses and non-profit organizations to reduce CO<INF>2</INF> 
emissions.
