---
granule: CREC-2005-07-20-pt1-PgH6196
date: 2005-07-20
edition: CREC
section: HOUSE
page: H6196
citation: 151 Cong. Rec. H6196
---
...
trick, how this works.
  CO<INF>2</INF> is like glass in that it allows light energy to come 
in but not go out. It is like a one-way door. And the reason it is like 
that is that CO<INF>2</INF> molecules block ultraviolet rays of light, 
...
CO<INF>2</INF> concentrations in a red line. This is the most 
...
per million, how many molecules of CO<INF>2</INF> per million there are 
in the atmosphere.
...
of CO<INF>2</INF> and you know exactly how much CO<INF>2</INF> there 
was. So this is a very precise measurement.

  So we know a thousand years ago CO<INF>2</INF> levels were 278 or 
...
about a hundred years ago we started to see an uptick of CO<INF>2</INF> 
...
the fastest rate of CO<INF>2</INF> acquisition or increase in global 
...
CO<INF>2</INF> captures heat and it traps heat and you increase the 
...
will all change as these CO<INF>2</INF> levels skyrocket.
...
times worse than CO<INF>2</INF>. So when you melt the tundra, you 
...
changing dramatically because of the increasing CO<INF>2</INF> levels 
in the atmosphere. What we see on this chart at first seems like an 
abstraction; but when you see these CO<INF>2</INF> levels going up 
...
President refuses to do anything about. We need a CO<INF>2</INF> cap to 
lead us in ways that we can reduce our contributions of CO<INF>2</INF>.
...
have gotten, as we increase our mileage, we reduce our CO<INF>2</INF> 
emissions.
...
percent of the world's CO<INF>2</INF> production. The oil simply is not 
