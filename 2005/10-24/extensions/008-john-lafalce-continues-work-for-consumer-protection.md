---
granule: CRECB-2005-pt17-Pg23524
date: 2005-10-24
edition: CRECB
section: EXTENSIONS
page: 23524
...
[[Page 23525]]
  ...
  iii. banks are advertising ``free'' checking accounts while making 
     ...
     program vendors in the country, banks profit from overdraft 
     protection whether or not the program itself is advertised. 
     This is because profits are made from customer usage, whether 
     the usage is planned or purely inadvertent. Not surprisingly, 
     banks are pairing their overdraft protection programs with 
     accounts that have strong consumer appeal, such as the so-
     ...
     statements that the bank will cover any and all overdrafts if 
     the bank, in fact, reserves the right not to do so; and 
     statements that a negative account balance may be maintained, 
     if the consumer, in fact, has to promptly cover the 
     overdraft.
